...
export const truthMarketAbi = parseAbi([
  ...
  "function MAX_JURY_SIZE() view returns (uint32)",
  "function MAX_JURY_PERCENTAGE() view returns (uint256)",
  ...
  "function getConfig() view returns ((address stakeToken, address treasury, address admin, address juryCommitter, address creator, string name, string description, string[] tags, bytes ipfsHash, uint64 votingDeadline, uint64 juryCommitDeadline, uint64 revealDeadline, uint8 protocolFeePercent, uint96 minStake, uint32 jurySize, uint32 minCommits, uint32 minRevealedJurors, uint32 maxJurySize, uint256 maxJuryPercentage, uint256 maxTags, uint256 maxNameBytes, uint256 maxDescriptionBytes, uint256 maxTagBytes, uint256 maxIpfsHashBytes, uint8 riskPercent, uint8 maxProtocolFeePercent))",
  ...
  "function commitJury(uint256 randomness, bytes32 auditHash)",
  "function resolve()",
  "function withdraw()",
  "event MarketStarted(string name, string description, string[] tags, bytes ipfsHash, uint64 votingDeadline, uint64 juryCommitDeadline, uint64 revealDeadline, uint32 jurySize, uint32 minCommits, uint32 minRevealedJurors, uint96 minStake)",
