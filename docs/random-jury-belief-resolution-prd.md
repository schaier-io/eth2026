...
TruthMarket lets users create immutable claim/rules documents, stake on YES/NO outcomes, privately commit votes, and later reveal votes after SpaceComputer randomness selects a resolving jury. Selected jurors determine the outcome. All voters reveal to settle their stake. Winners receive their stake back plus a share of the slashed pool; losers and non-revealers lose only the risked portion of their stake according to their chosen conviction.
...
10. As a high-conviction voter, I want more influence and upside when I risk more, so that stronger belief is economically meaningful.
...
18. As a non-revealing voter, I want clear consequences, so that I understand unrevealed votes cannot claim funds.
...
23. As a protocol participant, I want square-root stake weighting, so that stake matters without letting a single whale dominate linearly.
24. As a large staker, I want more influence than a small staker, so that economic conviction has value.
25. As a small staker, I want whale influence reduced, so that the random jury remains meaningfully plural.
...
- Juror resolution uses square-root conviction weighting.
- Conviction controls the portion of stake at risk.
- Conviction affects both outcome influence and reward upside.
...
- Non-revealing voters lose the risked portion because unrevealed votes cannot be classified as winning or losing.
- Winning voters receive stake back plus a share of slashed stake.
...
- **Conviction accounting module:** owns risked stake, refundable stake, slashed-pool accounting, winner reward weights, and payout math.
- **Jury weighting module:** owns square-root conviction weighting for selected juror reveals and outcome calculation.
...
- Square-root conviction weighting should be tested across small, medium, and large stakes.
- Partial slashing should be tested for low-conviction and full-conviction voters.
- Winner payout should be tested to confirm winners receive returned stake plus slashed-pool upside.
- Losing payout should be tested to confirm only the risked portion is slashed.
- Non-reveal behavior should be tested for selected jurors and non-selected voters.
